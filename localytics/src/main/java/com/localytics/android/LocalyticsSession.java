...
public class LocalyticsSession
{
    ...
    /* package */static final class SessionHandler extends Handler
    {
        ...
        /**
         * {@link com.localytics.android.LocalyticsProvider.ApiKeysDbColumns#_ID} for the API key used by this Localytics session handler.
         */
        ...
        /**
         * Projection for {@link #getOpenSessionId(com.localytics.android.LocalyticsProvider)}.
         */
        private static final String[] PROJECTION_GET_OPEN_SESSION_ID_SESSION_ID = new String[]
            { SessionsDbColumns._ID };

        /**
         * Projection for getting the event count in {@link #getOpenSessionId(com.localytics.android.LocalyticsProvider)}.
         */
        private static final String[] PROJECTION_GET_OPEN_SESSION_ID_EVENT_COUNT = new String[]
            { EventsDbColumns._COUNT };

        /**
         * Selection for {@link #getOpenSessionId(com.localytics.android.LocalyticsProvider)}.
         */
         ...
         * @return The {@link com.localytics.android.LocalyticsProvider.SessionsDbColumns#_ID} of the currently open session or {@code null} if no session is open. The
         ...
         *
         * @effects Updates the database by creating a new entry in the {@link com.localytics.android.LocalyticsProvider.SessionsDbColumns} table.
        ...
        /**
         * Projection for getting the installation ID. Used by {@link #getInstallationId(com.localytics.android.LocalyticsProvider, String)}.
         */
        private static final String[] PROJECTION_GET_INSTALLATION_ID = new String[]
            { ApiKeysDbColumns.UUID };

        /**
         * Selection for a specific API key ID. Used by {@link #getInstallationId(com.localytics.android.LocalyticsProvider, String)}.
         */
        ...
        /**
         * Projection for {@link #getNumberOfSessions(com.localytics.android.LocalyticsProvider)}.
         */
         ...
         *
         * @param provider Instance of {@link com.localytics.android.LocalyticsProvider}. Cannot be null.
        ...
        /**
         * Projection for {@link #preUploadBuildBlobs(com.localytics.android.LocalyticsProvider)}.
         */
        ...
        /**
         * Columns to join in {@link #preUploadBuildBlobs(com.localytics.android.LocalyticsProvider)}.
         */
        ...
        /**
         * Projection for {@link #isOptedOut(com.localytics.android.LocalyticsProvider, String)}.
         */
        private static final String[] PROJECTION_IS_OPTED_OUT = new String[]
            { ApiKeysDbColumns.OPT_OUT };

        /**
         * Selection for {@link #isOptedOut(com.localytics.android.LocalyticsProvider, String)}.
         * <p>
         * The selection argument is the {@link com.localytics.android.LocalyticsProvider.ApiKeysDbColumns#API_KEY}.
         */
    ...
    /* package */static final class UploadHandler extends Handler
    {
         ...
         * @param apiKey Localytics API key. Cannot be null.
         * @param sessionId The {@link com.localytics.android.LocalyticsProvider.SessionsDbColumns#_ID} of the session.
        ...
        /* package */static JSONObject getAttributesFromSession(final LocalyticsProvider provider, final String apiKey, final long sessionId) throws JSONException
        {
            ...
            try
            {
                ...
                if (cursor.moveToFirst())
                {
                    ...
                    result.put(BlobHeader.Attributes.KEY_DEVICE_WIFI_MAC_HASH, cursor.isNull(cursor.getColumnIndexOrThrow(SessionsDbColumns.DEVICE_WIFI_MAC_HASH)) ? JSONObject.NULL
         ...
         * @param context Application context. Cannot be null.
         * @param eventId {@link com.localytics.android.LocalyticsProvider.EventsDbColumns#_ID} of the event to convert.
         * @param blobId {@link com.localytics.android.LocalyticsProvider.UploadBlobEventsDbColumns#_ID} of the upload blob that contains this event.
        ...
        /**
         * Private helper to get the {@link com.localytics.android.LocalyticsProvider.SessionsDbColumns#_ID} for a given {@link com.localytics.android.LocalyticsProvider.EventsDbColumns#_ID}.
         *
         * @param provider Localytics database instance. Cannot be null.
         * @param eventId {@link com.localytics.android.LocalyticsProvider.EventsDbColumns#_ID} of the event to look up
         * @return The {@link com.localytics.android.LocalyticsProvider.SessionsDbColumns#_ID} of the session that owns the event.
         */
        ...
        /**
         * Private helper to get the {@link com.localytics.android.LocalyticsProvider.SessionsDbColumns#UUID} for a given {@link com.localytics.android.LocalyticsProvider.SessionsDbColumns#_ID}.
         *
         * @param provider Localytics database instance. Cannot be null.
         * @param sessionId {@link com.localytics.android.LocalyticsProvider.SessionsDbColumns#_ID} of the event to look up
         * @return The {@link com.localytics.android.LocalyticsProvider.SessionsDbColumns#UUID} of the session.
         */
        ...
        /**
         * Private helper to get the {@link com.localytics.android.LocalyticsProvider.SessionsDbColumns#SESSION_START_WALL_TIME} for a given {@link com.localytics.android.LocalyticsProvider.SessionsDbColumns#_ID}.
         *
         * @param provider Localytics database instance. Cannot be null.
         * @param sessionId {@link com.localytics.android.LocalyticsProvider.SessionsDbColumns#_ID} of the event to look up
         * @return The {@link com.localytics.android.LocalyticsProvider.SessionsDbColumns#SESSION_START_WALL_TIME} of the session.
         */
         ...
         * @param provider Localytics database instance. Cannot be null.
         * @param context Application context. Cannot be null.
         * @param eventId {@link com.localytics.android.LocalyticsProvider.EventsDbColumns#_ID} of the event whose attributes are to be loaded.
         ...
         *
         * @param blobId {@link com.localytics.android.LocalyticsProvider.UploadBlobsDbColumns#_ID} of the upload blob.
