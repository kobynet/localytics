...
/* package */final class DatapointHelper
{
     ...
     * <p>
     * Note: this method will return null if {@link android.Manifest.permission#ACCESS_WIFI_STATE} is not available. This method will also return
     * null on devices that do not have Wi-Fi. Even if the application has {@link android.Manifest.permission#ACCESS_WIFI_STATE} and the device
     ...
     * @return A SHA-256 of the Wi-Fi MAC address. Null if a MAC is not available, or if {@link android.Manifest.permission#ACCESS_WIFI_STATE} is
     *         not available.
     */
